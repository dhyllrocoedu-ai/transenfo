...
<div class="card stat-card mx-auto" style="max-width:640px">
    <div class="card-body p-4">
        ...
        <div class="row mb-2"><div class="col-5 text-muted">Payment Method</div><div class="col-7">{{ $payment->payment_method->label() }}</div></div>
        ...
        <div class="row mb-2"><div class="col-5 text-muted">Date Paid</div><div class="col-7">{{ $payment->paid_at->format('M d, Y h:i A') }}</div></div>
        <hr>
